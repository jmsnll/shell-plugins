...
func DatabaseCredentials() schema.CredentialType {
	return schema.CredentialType{
		...
		DefaultProvisioner: provision.TempFile(mysqlConfig, provision.Filename("my.cnf"), provision.AddArgs(provision.ArgPlacement{Mode: provision.AtEnd}, "--defaults-file={{ .Path }}")),
